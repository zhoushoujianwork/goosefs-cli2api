...
# GOOS=darwin GOARCH=arm64 CGO_ENABLED=1 go build -o ./bin/goosefs-cli2api-darwin-arm64 -ldflags "-X main.version=$RELEASE"
# GOOS=darwin GOARCH=amd64 go build -o ./bin/goosefs-cli2api-darwin-amd64 -ldflags "-X main.version=$RELEASE"
GOOS=linux GOARCH=amd64 CGO_ENABLED=1 go build -o ./bin/goosefs-cli2api-linux-amd64 -ldflags "-X main.version=$RELEASE"
